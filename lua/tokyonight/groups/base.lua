...
function M.get(c, opts)
  ...
  return {
    ...
    DiagnosticVirtualTextInfo   = { bg = opts.transparent and c.none or Util.blend_bg(c.info, 0.1), fg = c.info }, -- Used for "Information" diagnostic virtual text
    DiagnosticVirtualTextHint   = { bg = opts.transparent and c.none or Util.blend_bg(c.hint, 0.1), fg = c.hint }, -- Used for "Hint" diagnostic virtual text
